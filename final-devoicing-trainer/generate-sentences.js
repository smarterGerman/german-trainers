...
const phrases = [
  ...
  // === ENDS IN T (sounds like t, spelled t) ===
  { word: "Brot", phrase: "frisches Brot", hint: "frische Brote", file: "Brot_phrase", hintFile: "Brote_phrase" },
  { word: "Wort", phrase: "ein kurzes Wort", hint: "kurze Worte", file: "Wort_phrase", hintFile: "Worte_phrase" },
  { word: "Ort", phrase: "ein schöner Ort", hint: "schöne Orte", file: "Ort_phrase", hintFile: "Orte_phrase" },
  { word: "Sport", phrase: "viel Sport", hint: "viele Sportarten", file: "Sport_phrase", hintFile: "Sportarten_phrase" },
  { word: "Rat", phrase: "ein guter Rat", hint: "gute Ratschläge", file: "Rat_phrase", hintFile: "Ratschlaege_phrase" },
  { word: "Blatt", phrase: "ein grünes Blatt", hint: "grüne Blätter", file: "Blatt_phrase", hintFile: "Blaetter_phrase" },
  { word: "Stadt", phrase: "eine große Stadt", hint: "große Städte", file: "Stadt_phrase", hintFile: "Staedte_phrase" },
  { word: "Nacht", phrase: "eine lange Nacht", hint: "lange Nächte", file: "Nacht_phrase", hintFile: "Naechte_phrase" },
  { word: "Macht", phrase: "große Macht", hint: "große Mächte", file: "Macht_phrase", hintFile: "Maechte_phrase" },
  { word: "Licht", phrase: "helles Licht", hint: "helle Lichter", file: "Licht_phrase", hintFile: "Lichter_phrase" },
  { word: "Gesicht", phrase: "ein freundliches Gesicht", hint: "freundliche Gesichter", file: "Gesicht_phrase", hintFile: "Gesichter_phrase" },
  { word: "Frucht", phrase: "eine reife Frucht", hint: "reife Früchte", file: "Frucht_phrase", hintFile: "Fruechte_phrase" },
  { word: "Flucht", phrase: "die schnelle Flucht", hint: "schnelle Fluchten", file: "Flucht_phrase", hintFile: "Fluchten_phrase" },
  { word: "Sucht", phrase: "eine starke Sucht", hint: "starke Süchte", file: "Sucht_phrase", hintFile: "Suechte_phrase" },
  { word: "Sicht", phrase: "gute Sicht", hint: "gute Sichten", file: "Sicht_phrase", hintFile: "Sichten_phrase" },
  { word: "Gewicht", phrase: "hohes Gewicht", hint: "hohe Gewichte", file: "Gewicht_phrase", hintFile: "Gewichte_phrase" },
  ...
  // === ENDS IN P (sounds like p, spelled p) ===
  { word: "Kopf", phrase: "ein kluger Kopf", hint: "kluge Köpfe", file: "Kopf_phrase", hintFile: "Koepfe_phrase" },
  { word: "Topf", phrase: "ein großer Topf", hint: "große Töpfe", file: "Topf_phrase", hintFile: "Toepfe_phrase" },
  { word: "Kampf", phrase: "ein harter Kampf", hint: "harte Kämpfe", file: "Kampf_phrase", hintFile: "Kaempfe_phrase" },
  { word: "Dampf", phrase: "heißer Dampf", hint: "heiße Dämpfe", file: "Dampf_phrase", hintFile: "Daempfe_phrase" },
  { word: "Strumpf", phrase: "ein warmer Strumpf", hint: "warme Strümpfe", file: "Strumpf_phrase", hintFile: "Struempfe_phrase" },
  { word: "Sumpf", phrase: "ein tiefer Sumpf", hint: "tiefe Sümpfe", file: "Sumpf_phrase", hintFile: "Suempfe_phrase" },
  { word: "Rumpf", phrase: "der starke Rumpf", hint: "starke Rümpfe", file: "Rumpf_phrase", hintFile: "Ruempfe_phrase" },
  { word: "Zopf", phrase: "ein langer Zopf", hint: "lange Zöpfe", file: "Zopf_phrase", hintFile: "Zoepfe_phrase" },
  ...
  // === ENDS IN K (sounds like k, spelled k) ===
  { word: "Blick", phrase: "ein kurzer Blick", hint: "kurze Blicke", file: "Blick_phrase", hintFile: "Blicke_phrase" },
  { word: "Glück", phrase: "viel Glück", hint: "viel Glückes", file: "Glueck_phrase", hintFile: "Glueckes_phrase" },
  { word: "Stück", phrase: "ein großes Stück", hint: "große Stücke", file: "Stueck_phrase", hintFile: "Stuecke_phrase" },
  { word: "Druck", phrase: "hoher Druck", hint: "hohe Drücke", file: "Druck_phrase", hintFile: "Druecke_phrase" },
  { word: "Truck", phrase: "ein großer Truck", hint: "große Trucks", file: "Truck_phrase", hintFile: "Trucks_phrase" },
  { word: "Stock", phrase: "ein dicker Stock", hint: "dicke Stöcke", file: "Stock_phrase", hintFile: "Stoecke_phrase" },
  { word: "Block", phrase: "ein schwerer Block", hint: "schwere Blöcke", file: "Block_phrase", hintFile: "Bloecke_phrase" },
  { word: "Schock", phrase: "ein großer Schock", hint: "große Schocks", file: "Schock_phrase", hintFile: "Schocks_phrase" },
  { word: "Rock", phrase: "ein kurzer Rock", hint: "kurze Röcke", file: "Rock_phrase", hintFile: "Roecke_phrase" },
  { word: "Trick", phrase: "ein guter Trick", hint: "gute Tricks", file: "Trick_phrase", hintFile: "Tricks_phrase" },
  { word: "Lack", phrase: "roter Lack", hint: "rote Lacke", file: "Lack_phrase", hintFile: "Lacke_phrase" },
  { word: "Pack", phrase: "ein schweres Pack", hint: "schwere Packen", file: "Pack_phrase", hintFile: "Packen_phrase" },
  { word: "Sack", phrase: "ein voller Sack", hint: "volle Säcke", file: "Sack_phrase", hintFile: "Saecke_phrase" },
  { word: "Geschmack", phrase: "guter Geschmack", hint: "gute Geschmäcker", file: "Geschmack_phrase", hintFile: "Geschmaecker_phrase" },
  { word: "Zweck", phrase: "ein klarer Zweck", hint: "klare Zwecke", file: "Zweck_phrase", hintFile: "Zwecke_phrase" },
  { word: "Schreck", phrase: "ein großer Schreck", hint: "große Schrecken", file: "Schreck_phrase", hintFile: "Schrecken_phrase" },
];
